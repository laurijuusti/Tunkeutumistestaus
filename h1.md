...
Kokeilin tätä ekaksi vagrantilla automatisoida, mutta se ei toiminut. Kokeilin siis manuaalisesti. Kali VM oli jo virtuaaliboksissa, Metasploitable koneen tein vagrantilla käsin. 
...
Ajoin `vagrant up` ja kone käynnistyi. Sammutin molemmat virtuaalikoneet ja menin virtualboxin asetuksista laittamaan molemmille Bridged networking moden päälle kohdasta Settings - Network - Adapter 1 - Attached to Bridged Adapter. Käynnistin koneet uudestaan ja tämän jälkeen onnistui kommunikointi koneiden välillä:
