...
Tein Kalin file managerissa kansion Tobecracked johon laitoin tekstitiedoston ja zippasin sen .7z formattiin ja laitoin salasanaksi ANGER.

Sitten tein siitä hashin komennolla `/john/run/7z2john.pl Tobecracked.7z > Tobecracked.7z.hash`. Sitten ajoin `john/run/john --wordlist=passwords.txt Tobecracked.7z.hash`. Then we wait. Toivottavasti ei 20 tuntia:

![image](https://github.com/user-attachments/assets/f2289498-96a4-4ecf-9250-e42ba92e2139)
